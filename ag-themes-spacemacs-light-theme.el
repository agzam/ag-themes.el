...
(ag-themes-deftheme ag-themes-spacemacs-light
  "Customized theme based on spacemacs-light."
  :base spacemacs-light
  ...
  (default :background (lighter 0)
   window-divider :foreground (lighter 0 default :background)
   window-divider-first-pixel :foreground (lighter 10 default :background)
   window-divider-last-pixel :foreground (lighter 10 default :background)
   mode-line :underline unspecified :box (:color bg-accent) :background (darker 8 default :background)
   mode-line-inactive :underline unspecified :box (:color bg-accent) :background (darker 2 default :background)
   doom-modeline :inherit mode-line
   doom-modeline-bar :background (darker 5 default :background)
   doom-modeline-bar-inactive :inherit fringe
   cursor :background "DarkGoldenrod2"

   dired-subtree-depth-1-face :background (darker 2 dired-directory :background)
   dired-subtree-depth-2-face :background (darker 6 dired-directory :background)
   dired-subtree-depth-3-face :background (darker 8 dired-directory :background)
   dired-subtree-depth-4-face :background (darker 10 dired-directory :background)
   dired-subtree-depth-5-face :background (darker 15 dired-directory :background)
   dired-subtree-depth-6-face :background (darker 20 dired-directory :background)

   fringe :background (darker 2 default :background)
   ...
   ivy-posframe-border :background (lighter 5 default :foreground)
   ...
   ansi-color-faint :foreground (lighter 10 default :foreground)))
