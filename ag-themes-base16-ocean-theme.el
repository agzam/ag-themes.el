...
;;; Commentary:
;;
;; Customized theme based on base16-ocean.
;;
;;; Code:

(require 'ag-themes)

(ag-themes-deftheme ag-themes-base16-ocean
  "Customized theme based on base16-ocean."
  :base base16-ocean
  :modeline-height 0.85
  :palette ((base00 . "#2e323c")
            (base01 . "#343d46")
            (base02 . "#5b6a78")
            (base03 . "#65737e")
            (base04 . "#a7adba")
            ...
            (base0E . "#b48ead")
            (base10 . "#7090af")
            (default-background . "#2e323c"))
  :faces
  (default :background (lighter 5)
   button :foregorund base0C
   window-divider :foreground (lighter 0 default :background)
   window-divider-first-pixel :foreground (lighter 0 default :background)
   window-divider-last-pixel :foreground (lighter 0 default :background)
   mode-line :underline unspecified :background (lighter 3 default :background)
   mode-line-inactive :underline nil :background (lighter 5 default :background)
   doom-modeline-bar :background (lighter 20 default :background)
   doom-modeline-bar-inactive :inherit fringe
   cursor :background "DarkGoldenrod2"
   show-paren-match :background unspecified :foreground (lighter 0 cursor :background) :underline t
   ...
   org-level-1 :foreground base0D :height 1.5
   org-level-2 :foreground base09 :height 1.0
   org-level-3 :foreground base0B :height 1.0
   ...
   term-color-blue :foreground (lighter 2 default :foreground)
